...
const sliderSlides = [
  ...
  { id: 3, title: 'Then we build the story.', subtitle: '', image: '/landing/shop.jpeg', targetId: 'about' },
  ...
  { id: 9, title: 'Make the ordinary unforgettable.', subtitle: '', image: '/pictures/balloon.JPG', targetId: 'about' },
